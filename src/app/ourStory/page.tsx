...
export default function AboutPage() {
  return (
    <main className="min-h-screen bg-[#fafafa] overflow-x-hidden">
      {/* Hero */}
      <section className="relative pt-24 lg:pt-32 pb-16 lg:pb-20 overflow-hidden bg-gradient-to-b from-[#f5f5f5] to-[#fafafa]">
        <Leaf variant="a" className="absolute top-28 left-[8%] w-20 h-20 text-zinc-400/20 rotate-12 hidden lg:block" />
        <Leaf variant="b" className="absolute bottom-8 right-[10%] w-16 h-16 text-zinc-500/20 -rotate-12 hidden lg:block" />
        <div className="relative mx-auto max-w-4xl px-4 text-center">
          <div className="inline-flex items-center gap-2 rounded-full bg-white/70 border border-zinc-200 px-5 py-2 shadow-sm mb-6">
            <FaLeaf className="text-zinc-600" />
            <span className="text-xs font-bold uppercase tracking-widest text-zinc-700">Our Story</span>
          </div>
          <h1 className="text-4xl sm:text-6xl font-bold text-[#111111] leading-tight">
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 lg:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          <div className="relative order-2 lg:order-1" >
            <div className="absolute -top-6 -left-6 w-40 h-40 bg-zinc-100/70 rounded-full blur-2xl" />
            <div className="relative aspect-[4/5] rounded-[2.5rem] overflow-hidden bg-gradient-to-br from-[#111111] via-[#333333] to-[#1a1a1a] flex items-center justify-center p-8 shadow-2xl shadow-zinc-900/30">
            ...
            <div className="absolute -bottom-6 -right-4 bg-white rounded-2xl shadow-xl border border-zinc-100 px-6 py-4">
              <p className="text-2xl font-bold text-zinc-700">30,000+</p>
          ...
          <div className="order-1 lg:order-2">
            ...
            <div className="mt-6 space-y-4 text-zinc-600 leading-relaxed">
              ...
              <p>
                ANSA Naturals was founded on a simple conviction: <strong className="text-zinc-700">purity should never be compromised.</strong>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link href="/products" className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-[#111111] to-[#333333] text-white px-8 py-3.5 font-bold text-sm shadow-lg hover:shadow-zinc-900/30 hover:-translate-y-0.5 transition-all active:scale-95">
                Shop the Oil
              </Link>
              <Link href="/#benefits" className="inline-flex items-center gap-2 rounded-full bg-white border border-zinc-200 text-zinc-700 px-8 py-3.5 font-bold text-sm hover:bg-zinc-50 transition-all active:scale-95">
                See the Benefits
              </Link>
            </div>
          </div>
      ...
      <section className="bg-zinc-50 border-y border-zinc-100 py-20">
        <div className="mx-auto max-w-7xl px-4">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-[#111111]">The Values That Shape Us</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((v, i) => (
              <div key={i} className="bg-white p-8 rounded-3xl border border-zinc-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
                <div className="w-14 h-14 bg-zinc-50 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-gradient-to-br group-hover:from-[#111111] group-hover:to-[#333333] group-hover:text-white transition-all">
                  {v.icon}
                </div>
      ...
      <section className="mx-auto max-w-7xl px-4 py-20">
        <div className="relative rounded-[2.5rem] overflow-hidden bg-gradient-to-br from-[#111111] via-[#333333] to-[#1a1a1a] p-10 sm:p-16 text-center shadow-2xl">
          <Leaf variant="a" className="absolute -left-4 -bottom-4 w-28 h-28 text-zinc-200/10 rotate-12" />
          ...
          <div className="relative">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-4">
              <Link href="/products" className="inline-flex items-center gap-2 rounded-full bg-white text-zinc-800 px-10 py-4 font-bold shadow-xl hover:bg-amber-50 transition-all active:scale-95">
                Order Now
              </Link>
